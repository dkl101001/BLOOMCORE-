...
from .execution import describe_invocation
...
def main() -> int:
    ...
    payload["execution"] = describe_invocation("cli:main")
    print(json.dumps(payload, ensure_ascii=False, indent=2 if args.pretty else None, sort_keys=True, allow_nan=False))
